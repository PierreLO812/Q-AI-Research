...
void generate_report(const std::string& hypothesis, bool verified, double conf, const std::string& eq, const std::string& json_mcp, const std::string& svg_bloch) {
...
int main(int argc, char** argv) {
    ...
    AlHilbertCore alh;
    // Assume it finds x^2 + x as the best fit to the simulated data
    ...
    generate_report(hypothesis, is_formally_proved, 99.9, discovered_law->to_string(), mcp_json, svg_bloch);
